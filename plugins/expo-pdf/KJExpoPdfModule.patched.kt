...
class KJExpoPdfModule : Module() {
  ...
  override fun definition() = ModuleDefinition {
    ...
    View(KJExpoPdfView::class) {
      ...
      // QA fix (BUG-14): zero-based logical page to jump to. Sent as a Float for
      // the same reason as pageGap, because the JS number bridge is floating
      // point; null clears the request without reloading the document.
      Prop("page") { view: KJExpoPdfView, page: Float? ->
        view.setPage(page?.roundToInt())
      }
