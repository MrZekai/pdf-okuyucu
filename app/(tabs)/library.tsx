...
const styles=StyleSheet.create({safe:{flex:1,backgroundColor:palette.ink},header:{padding:18,paddingBottom:12,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},kicker:{color:palette.pdfRedSoft,fontSize:9,fontWeight:'900',letterSpacing:1.8},title:{color:palette.white,fontSize:25,fontWeight:'900',marginTop:4},add:{width:43,height:43,borderRadius:14,backgroundColor:palette.pdfRed,alignItems:'center',justifyContent:'center'},search:{height:48,marginHorizontal:18,borderRadius:15,backgroundColor:palette.card,borderWidth:1,borderColor:palette.line,flexDirection:'row',alignItems:'center',paddingHorizontal:13,gap:9},input:{flex:1,color:palette.white,fontSize:13.5},filters:{flexDirection:'row',gap:8,paddingHorizontal:18,paddingTop:10},filter:{minHeight:36,borderRadius:12,paddingHorizontal:14,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:6,backgroundColor:palette.card,borderWidth:1,borderColor:palette.line},filterActive:{backgroundColor:palette.pdfRedDeep,borderColor:palette.pdfRed},filterText:{color:palette.muted,fontSize:11,fontWeight:'800'},filterTextActive:{color:'#fff'},content:{padding:18,paddingTop:14,paddingBottom:30},empty:{alignItems:'center',justifyContent:'center',paddingVertical:80},emptyTitle:{color:'#D0D3D8',fontSize:16,fontWeight:'800',marginTop:16},emptyText:{color:palette.muted,fontSize:12,marginTop:6,textAlign:'center'}});
