  ...
  return (
    <SafeAreaView edges={['top']} style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.brandRow}><Text style={styles.eyebrow}>{t('home.eyebrow')}</Text></View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickGrid}>
            ...
            <Quick icon="heart" title={t('home.quickFavTitle')} desc={favoriteCount===1?t('home.quickFavDescOne'):t('home.quickFavDesc',{count:favoriteCount})} color={palette.rose} onPress={() => router.push('/favorites')}/>
...
const styles = StyleSheet.create({
  ...
  brandRow:{paddingTop:2}, eyebrow:{color:'#7C89FF',fontSize:10,fontWeight:'900',letterSpacing:2.3},
