  ...
  return (
    <SafeAreaView edges={['top']} style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.brandRow}><Text style={styles.eyebrow}>{t('home.eyebrow')}</Text><Text style={styles.welcome}>{t('home.welcome')}</Text></View>
...
const styles = StyleSheet.create({
  ...
  brandRow:{paddingTop:2}, eyebrow:{color:'#7C89FF',fontSize:10,fontWeight:'900',letterSpacing:2.3}, welcome:{color:palette.white,fontSize:20,fontWeight:'800',marginTop:4},
