...
const tr = {
  ...
  'settings.adPauseThanks': 'Teşekkürler. 30 dakika boyunca reklam görmeyeceksin.',
...
const en: Record<keyof typeof tr, string> = {
  ...
  'settings.adPauseThanks': 'Thanks. You will not see any ads for the next 30 minutes.',
...
const es: Record<keyof typeof tr, string> = {
  ...
  'settings.adPauseThanks': 'Gracias. No verás anuncios durante los próximos 30 minutos.',
