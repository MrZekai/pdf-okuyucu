...
const tr = {
  ...
  'tools.compressLossyMessage': 'Bu PDF, görsellerine dokunmadan küçültülemedi. Görsel kalitesini düşürerek küçültelim mi?',
...
const en: Record<keyof typeof tr, string> = {
  ...
  'tools.compressLossyMessage': 'This PDF could not be made smaller without changing its images. Reduce image quality to shrink it?',
...
const es: Record<keyof typeof tr, string> = {
  ...
  'tools.compressLossyMessage': 'Este PDF no se pudo reducir sin tocar sus imágenes. ¿Bajamos la calidad de las imágenes para comprimirlo?',
