...
const tr = {
  ...
  'settings.adPauseTitle': '30 dakika reklamsız',
  'settings.adPauseDesc': 'Kısa bir reklam videosu izle, 30 dakika boyunca reklamsız kullan.',
...
const en: Record<keyof typeof tr, string> = {
  ...
  'settings.adPauseTitle': '30 minutes without ads',
  'settings.adPauseDesc': 'Watch a short ad video and use the app ad free for 30 minutes.',
...
const es: Record<keyof typeof tr, string> = {
  ...
  'settings.adPauseTitle': '30 minutos sin anuncios',
  'settings.adPauseDesc': 'Mira un vídeo publicitario corto y usa la app sin anuncios durante 30 minutos.',
