...
const tr = {
  ...
  'settings.adPauseDesc': 'Kısa bir video izle, 30 dakika boyunca hiç reklam görme.',
...
const en: Record<keyof typeof tr, string> = {
  ...
  'settings.adPauseDesc': 'Watch a short video and see no ads for 30 minutes.',
...
const es: Record<keyof typeof tr, string> = {
  ...
  'settings.adPauseDesc': 'Mira un vídeo corto y no verás anuncios durante 30 minutos.',
