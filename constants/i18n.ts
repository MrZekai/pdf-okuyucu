...
const tr = {
  ...
  'tools.localOnly': 'CİHAZDA İŞLENİR • PDF YÜKLENMEZ',
  'tools.createSection': 'OLUŞTUR VE DÖNÜŞTÜR',
  'tools.organizeSection': 'SAYFALARI YÖNET',
  'tools.finishSection': 'TAMAMLA VE ÇIKTI AL',
  'tools.scanTitle': 'Kameradan PDF',
  ...
  'tools.compressTitle': 'PDF’yi sıkıştır',
  'tools.compressDesc': 'Paylaşmak için dosya boyutunu küçült',
  'tools.compressResult': '{before} → {after} (%{percent} küçüldü)',
  'tools.compressLossyMessage': 'Bu PDF, görsellerine dokunmadan kayda değer ölçüde küçültülemedi. Görsel kalitesini düşürerek küçültelim mi?',
  ...
  'tools.mergeTooManyFiles': 'Tek seferde en fazla {count} PDF birleştirilebilir. Daha az dosya seçin.',
  ...
  'tools.tooLarge': 'PDF araçları için toplam dosya boyutu 40 MB’ı geçemez.',
  ...
  'tools.cameraBlockedMessage': 'Kamera izni kapalı. Belge taramak için Ayarlar bölümünden kamera iznini açın.',
  ...
  'tools.watermarkUnsupported': 'Bu karakterler filigranda henüz kullanılamıyor: {characters}',
  ...
  'settings.adPauseTitle': '10 dakika reklamsız',
  'settings.adPauseDesc': 'Kısa bir reklam videosu izle, 10 dakika boyunca reklamsız kullan.',
  'settings.adPauseActive': 'Reklamsız süre sürüyor: {minutes} dakika kaldı.',
  'settings.adPauseThanks': 'Teşekkürler. 10 dakika boyunca reklam görmeyeceksin.',
  'settings.adPauseUnavailable': 'Şu anda gösterilecek video yok. Biraz sonra tekrar dene.',
  ...
  'reader.damagedError': 'Bu PDF hasarlı veya açılamıyor.',
  'reader.goToPageTitle': 'Sayfaya git',
  'reader.goToPageMessage': '1 ile {total} arasında bir sayfa numarası girin.',
  'reader.goToPageConfirm': 'Git',
  ...
  'a11y.goToPage': 'Sayfa seçici, sayfaya gitmek için dokunun',
...
const en: Record<keyof typeof tr, string> = {
  ...
  'tools.compressDesc': 'Make the file smaller to share',
  'tools.compressResult': '{before} → {after} ({percent}% smaller)',
  'tools.compressLossyMessage': 'This PDF could not be made much smaller without changing its images. Reduce image quality to shrink it?',
  ...
  'tools.mergeTooManyFiles': 'At most {count} PDFs can be merged at once. Please select fewer files.',
  'tools.mergeTooLarge': 'The files selected for merging cannot exceed 40 MB in total.',
  ...
  'tools.tooLarge': 'The total file size for PDF tools cannot exceed 40 MB.',
  ...
  'tools.cameraBlockedMessage': 'Camera access is turned off. Open Settings to allow the camera and scan a document.',
  ...
  'tools.watermarkUnsupported': 'These characters cannot be used in a watermark yet: {characters}',
  ...
  'settings.adPauseTitle': '10 minutes without ads',
  'settings.adPauseDesc': 'Watch a short ad video and use the app ad free for 10 minutes.',
  'settings.adPauseActive': 'Ad free time is running: {minutes} minutes left.',
  'settings.adPauseThanks': 'Thanks. You will not see any ads for the next 10 minutes.',
  'settings.adPauseUnavailable': 'No video is available right now. Please try again in a moment.',
  ...
  'reader.damagedError': 'This PDF is damaged or cannot be opened.',
  'reader.goToPageTitle': 'Go to page',
  'reader.goToPageMessage': 'Enter a page number between 1 and {total}.',
  'reader.goToPageConfirm': 'Go',
  ...
  'a11y.goBack': 'Go back',
  'a11y.goToPage': 'Page selector, tap to go to a page',
...
const es: Record<keyof typeof tr, string> = {
  ...
  'tools.compressDesc': 'Reduce el tamaño del archivo para enviarlo',
  'tools.compressResult': '{before} → {after} ({percent}% menos)',
  'tools.compressLossyMessage': 'Este PDF no se pudo reducir mucho sin tocar sus imágenes. ¿Bajamos la calidad de las imágenes para comprimirlo?',
  ...
  'tools.mergeTooManyFiles': 'Se pueden combinar como máximo {count} PDF a la vez. Selecciona menos archivos.',
  'tools.mergeTooLarge': 'Los archivos seleccionados para combinar no pueden superar 40 MB en total.',
  ...
  'tools.tooLarge': 'El tamaño total para las herramientas PDF no puede superar 40 MB.',
  ...
  'tools.cameraBlockedMessage': 'El acceso a la cámara está desactivado. Abre Ajustes para permitir la cámara y escanear un documento.',
  ...
  'tools.watermarkUnsupported': 'Estos caracteres todavía no se pueden usar en una marca de agua: {characters}',
  ...
  'settings.adPauseTitle': '10 minutos sin anuncios',
  'settings.adPauseDesc': 'Mira un vídeo publicitario corto y usa la app sin anuncios durante 10 minutos.',
  'settings.adPauseActive': 'Tiempo sin anuncios: quedan {minutes} minutos.',
  'settings.adPauseThanks': 'Gracias. No verás anuncios durante los próximos 10 minutos.',
  'settings.adPauseUnavailable': 'No hay ningún vídeo disponible ahora. Inténtalo de nuevo en un momento.',
  ...
  'reader.damagedError': 'Este PDF está dañado o no se puede abrir.',
  'reader.goToPageTitle': 'Ir a la página',
  'reader.goToPageMessage': 'Introduce un número de página entre 1 y {total}.',
  'reader.goToPageConfirm': 'Ir',
  ...
  'a11y.goBack': 'Volver',
  'a11y.goToPage': 'Selector de página, toca para ir a una página',
